"use client"
import { GraduationCap, MapPin, Calendar, Briefcase, ExternalLink } from "lucide-react"
import { education, workExperience } from "@/data/index"

export default function Education() {
  return (
    <div id="education" className="min-h-screen py-8 md:py-16 px-4">
      <style jsx>{`
        @keyframes fadeInUp {
          from {
            opacity: 0;
      ...
      <div className="max-w-6xl mx-auto space-y-12 md:space-y-24">
        ...
        <div className="animate-fade-in-up">
          <div className="flex items-center justify-center gap-3 mb-8 md:mb-16 animate-scale-in">
        ...
        <div id="experience" className="animate-fade-in-up">
          {/* Header */}
          <div className="flex items-center justify-center gap-3 mb-8 md:mb-16 animate-scale-in">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-slate-800 rounded-full flex items-center justify-center animate-pulse-hover">
              <Briefcase className="w-5 h-5 md:w-6 md:h-6 text-blue-400" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-white">Work Experience</h1>
          </div>
                    ...
                    <div className="gradient-border-blue card-hover">
                      <div className="bg-slate-800 rounded-md p-4">
                        ...
                        <div className="flex items-center gap-2 mb-3">
                          <p className="text-blue-400 font-medium text-sm">{work.company}</p>
                          {work.link && (
                            <a href={work.link} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">
